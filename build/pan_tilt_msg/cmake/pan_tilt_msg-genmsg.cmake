...
set(MSG_I_FLAGS "-Ipan_tilt_msg:/home/caster/ros_ws/caster/src/iqr_pan_tilt/pan_tilt_msg/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/caster/ros_ws/caster/src/iqr_pan_tilt/pan_tilt_msg/msg/PanTiltCmd.msg" NAME_WE)
add_custom_target(_pan_tilt_msg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pan_tilt_msg" "/home/caster/ros_ws/caster/src/iqr_pan_tilt/pan_tilt_msg/msg/PanTiltCmd.msg" ""
)
...
_generate_msg_cpp(pan_tilt_msg
  "/home/caster/ros_ws/caster/src/iqr_pan_tilt/pan_tilt_msg/msg/PanTiltCmd.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pan_tilt_msg)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pan_tilt_msg\")")
  # install generated code
  install(
